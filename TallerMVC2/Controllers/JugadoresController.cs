...
namespace TallerMVC2.Controllers
{
    public class JugadoresController : Controller
    {
        ...
        public JugadoresController(SQLServer context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Sueldo,NumeroCamisa,Goles,Asistencias,Equipo")] Jugadores jugadores)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Sueldo,NumeroCamisa,Goles,Asistencias,Equipo")] Jugadores jugadores)
        {
            if (id != jugadores.Id)
            {
                return NotFound();
